<template>
    <section class="section">
        <div class="container has-text-centered">
            <h2 class="title">Phase {{ current }} : {{ phaseName(current) }}</h2>
            <ul v-if="current === 1">
                <li>Les joueurs doivent faire deviner un nom à leur équipe en respectant une règle :
                    ils ne peuvent pas dire ou traduire le nom ou une partie du nom à faire deviner.
                </li>
            ...
            <p>
                <button @click="next" class="button is-primary">OK</button>
            </p>
        </div>
    </section>
</template>
